function [timings_table] = tw_timingsComparePlot( first_alltimings, second_alltimings, frame_counts, first_names, second_names, first_all_name, second_all_name, title_name )
