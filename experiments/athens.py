...
klcluster = True
datafolder = "/home/jacobus/data/athens"
...
def run_solver_single_threaded(drifterFiles, delta, c2, l):
    ...
    # Refine
    S, cost, _ = refiner3.refine_cut_delta(elements, [delta] * len(elements), (1, c2, 128), 2)
...
if __name__ == "__main__":
    ...
    with open("athens_result.json", "w") as result_file:
